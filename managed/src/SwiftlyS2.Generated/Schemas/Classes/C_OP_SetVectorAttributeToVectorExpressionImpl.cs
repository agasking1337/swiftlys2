...
internal partial class C_OP_SetVectorAttributeToVectorExpressionImpl : CParticleFunctionOperatorImpl, C_OP_SetVectorAttributeToVectorExpression {
  ...
  public ref VectorExpressionType_t Expression {
    get {
      if (_ExpressionOffset == null) {
        _ExpressionOffset = Schema.GetOffset(0xF36D0C4160B2427);
      }
  ...
  public CPerParticleVecInput Input1 {
    get {
      if (_Input1Offset == null) {
        _Input1Offset = Schema.GetOffset(0xF36D0C4E17F27DA);
      }
  ...
  public CPerParticleVecInput Input2 {
    get {
      if (_Input2Offset == null) {
        _Input2Offset = Schema.GetOffset(0xF36D0C4E07F2647);
      }
  ...
  public CPerParticleFloatInput Lerp {
    get {
      if (_LerpOffset == null) {
        _LerpOffset = Schema.GetOffset(0xF36D0C4622FAB06);
      }
  ...
  public ParticleAttributeIndex_t OutputField {
    get {
      if (_OutputFieldOffset == null) {
        _OutputFieldOffset = Schema.GetOffset(0xF36D0C4324F6F74);
      }
  ...
  public ref ParticleSetMethod_t SetMethod {
    get {
      if (_SetMethodOffset == null) {
        _SetMethodOffset = Schema.GetOffset(0xF36D0C4FB53C31E);
      }
  ...
  public ref bool NormalizedOutput {
    get {
      if (_NormalizedOutputOffset == null) {
        _NormalizedOutputOffset = Schema.GetOffset(0xF36D0C40AA98C55);
      }
