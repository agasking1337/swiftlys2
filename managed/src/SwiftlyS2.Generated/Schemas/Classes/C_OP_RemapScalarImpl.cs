...
internal partial class C_OP_RemapScalarImpl : CParticleFunctionOperatorImpl, C_OP_RemapScalar {
  ...
  public ParticleAttributeIndex_t FieldInput {
    get {
      if (_FieldInputOffset == null) {
        _FieldInputOffset = Schema.GetOffset(0x580A448EAE775669);
      }
  ...
  public ParticleAttributeIndex_t FieldOutput {
    get {
      if (_FieldOutputOffset == null) {
        _FieldOutputOffset = Schema.GetOffset(0x580A448EE5729606);
      }
  ...
  public ref float InputMin {
    get {
      if (_InputMinOffset == null) {
        _InputMinOffset = Schema.GetOffset(0x580A448EE88A0D0F);
      }
  ...
  public ref float InputMax {
    get {
      if (_InputMaxOffset == null) {
        _InputMaxOffset = Schema.GetOffset(0x580A448ED6766901);
      }
  ...
  public ref float OutputMin {
    get {
      if (_OutputMinOffset == null) {
        _OutputMinOffset = Schema.GetOffset(0x580A448E5F8D7716);
      }
  ...
  public ref float OutputMax {
    get {
      if (_OutputMaxOffset == null) {
        _OutputMaxOffset = Schema.GetOffset(0x580A448E51A0E8C4);
      }
  ...
  public ref bool OldCode {
    get {
      if (_OldCodeOffset == null) {
        _OldCodeOffset = Schema.GetOffset(0x580A448EFB4CA66B);
      }
