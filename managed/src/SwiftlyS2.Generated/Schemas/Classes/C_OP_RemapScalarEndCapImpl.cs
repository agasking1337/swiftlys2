  ...
  public ParticleAttributeIndex_t FieldInput {
    get {
      if (_FieldInputOffset == null) {
        _FieldInputOffset = Schema.GetOffset(0x73A6F7F1AE775669);
      }
  ...
  public ParticleAttributeIndex_t FieldOutput {
    get {
      if (_FieldOutputOffset == null) {
        _FieldOutputOffset = Schema.GetOffset(0x73A6F7F1E5729606);
      }
  ...
  public ref float InputMin {
    get {
      if (_InputMinOffset == null) {
        _InputMinOffset = Schema.GetOffset(0x73A6F7F1E88A0D0F);
      }
  ...
  public ref float InputMax {
    get {
      if (_InputMaxOffset == null) {
        _InputMaxOffset = Schema.GetOffset(0x73A6F7F1D6766901);
      }
  ...
  public ref float OutputMin {
    get {
      if (_OutputMinOffset == null) {
        _OutputMinOffset = Schema.GetOffset(0x73A6F7F15F8D7716);
      }
  ...
  public ref float OutputMax {
    get {
      if (_OutputMaxOffset == null) {
        _OutputMaxOffset = Schema.GetOffset(0x73A6F7F151A0E8C4);
      }
