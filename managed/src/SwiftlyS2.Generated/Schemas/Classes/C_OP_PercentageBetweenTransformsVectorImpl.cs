  ...
  public ParticleAttributeIndex_t FieldOutput {
    get {
      if (_FieldOutputOffset == null) {
        _FieldOutputOffset = Schema.GetOffset(0x481FA5ADE5729606);
      }
  ...
  public ref float InputMin {
    get {
      if (_InputMinOffset == null) {
        _InputMinOffset = Schema.GetOffset(0x481FA5ADE88A0D0F);
      }
  ...
  public ref float InputMax {
    get {
      if (_InputMaxOffset == null) {
        _InputMaxOffset = Schema.GetOffset(0x481FA5ADD6766901);
      }
  ...
  public ref Vector OutputMin {
    get {
      if (_OutputMinOffset == null) {
        _OutputMinOffset = Schema.GetOffset(0x481FA5AD2EFED678);
      }
  ...
  public ref Vector OutputMax {
    get {
      if (_OutputMaxOffset == null) {
        _OutputMaxOffset = Schema.GetOffset(0x481FA5AD451280D2);
      }
  ...
  public CParticleTransformInput TransformStart {
    get {
      if (_TransformStartOffset == null) {
        _TransformStartOffset = Schema.GetOffset(0x481FA5ADD94FA7F9);
      }
  ...
  public CParticleTransformInput TransformEnd {
    get {
      if (_TransformEndOffset == null) {
        _TransformEndOffset = Schema.GetOffset(0x481FA5AD0C3277C8);
      }
  ...
  public ref ParticleSetMethod_t SetMethod {
    get {
      if (_SetMethodOffset == null) {
        _SetMethodOffset = Schema.GetOffset(0x481FA5ADFB53C31E);
      }
  ...
  public ref bool ActiveRange {
    get {
      if (_ActiveRangeOffset == null) {
        _ActiveRangeOffset = Schema.GetOffset(0x481FA5AD3FA53B84);
      }
  ...
  public ref bool RadialCheck {
    get {
      if (_RadialCheckOffset == null) {
        _RadialCheckOffset = Schema.GetOffset(0x481FA5AD496187DE);
      }
